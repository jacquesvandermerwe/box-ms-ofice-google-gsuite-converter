...
if [ "$TYPE" = "sheet" ]; then
    echo "--> Fetching raw Google Sheet (including Grid Data)..."
    # Changed extension to .gsheet
    ...
    echo "--> Fetching raw Google Doc DOM..."
    # Changed extension to .gdoc
...
echo "--> Uploading raw JSON to Box as '$FILE_NAME'..."
